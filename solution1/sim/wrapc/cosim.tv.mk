...
$(ObjDir)/c_mnist_test_suite.c_pre.c.tb.o : c_mnist_test_suite.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) c_mnist_test_suite.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/c_mnist.c_pre.c.tb.o : c_mnist.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) c_mnist.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
