...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "c_mnist.autotvin.dat"
	set constFileTvOut       "c_mnist.autotvout.dat"
	set constFileHdlTvIn     "c_mnist.autohdltvin.dat"
	set constFileHdlTvOut    "c_mnist.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
