...
#ifndef __c_mnist_fcmp_32nsbBo__HH__
#define __c_mnist_fcmp_32nsbBo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(c_mnist_fcmp_32nsbBo) {
    ...
    SC_CTOR(c_mnist_fcmp_32nsbBo):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
